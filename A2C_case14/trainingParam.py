...
class TrainingParam(object):
    _all_attr = ["SAVING_NUM", "gamma", "lmbda", "entropy_coeff", "max_step", "loss_weight", "kwargs_archi", "list_attr_obs", "model_name"]
    # _all_attr = ["SAVING_NUM", "gamma", "lmbda", "entropy_coeff", "max_step", "kwargs_archi", "list_attr_obs",
    #              "model_name"]
